        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-3xl mx-auto text-center">
            ...
            <motion.h1 variants={fadeInUp} className="font-heading text-5xl md:text-6xl font-bold text-foreground mb-6">
              <TextReveal text={t("about.title1")} /> <span className="animate-gradient-text">{t("about.title2")}</span> <TextReveal text={t("about.title3")} delay={0.3} />
            </motion.h1>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <ScrollReveal variant="fadeLeft">
              ...
              <h2 className="font-heading text-4xl font-bold mb-6 drop-shadow-sm text-[#5e5555]">
                <TextReveal text={t("about.storyTitle1")} /> <span className="text-primary">{t("about.storyTitle2")}</span>
              </h2>
            ...
            <ScrollReveal variant="rotateIn" delay={0.2}>
              <motion.div
                className="aspect-square bg-muted rounded-2xl overflow-hidden floating-shadow relative group"
                whileHover={{ scale: 1.03, rotate: 1 }}
                transition={{ type: "spring", stiffness: 200 }}
              >
                <motion.img
                  src={aboutStory}
                  alt="First Option UAE workshop"
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <ScrollReveal variant="blur">
              ...
              <h2 className="font-heading text-4xl font-bold text-foreground mb-6 drop-shadow-sm">
                <TextReveal text={t("about.missionTitle1")} /> <span className="text-primary">{t("about.missionTitle2")}</span>
              </h2>
                    ...
                    <Card className="bg-card border-border text-start card-hover-glow gradient-border">
                      <CardContent className="p-6 flex items-start gap-4">
                        <motion.div
                          ...
                          animate={{ boxShadow: ["0 0 0 0 hsl(var(--primary) / 0.1)", "0 0 0 10px hsl(var(--primary) / 0)", "0 0 0 0 hsl(var(--primary) / 0.1)"] }}
                        >
          ...
          <div className="max-w-3xl mx-auto">
            <ScrollReveal variant="slideUp">
              <div className="text-center mb-12">
                ...
                <h2 className="font-heading text-4xl font-bold drop-shadow-sm border-[#524747] text-[#7c6e6e]">
                  <TextReveal text={t("about.whyTitle1")} /> <span className="text-primary">{t("about.whyTitle2")}</span>
                </h2>
              </div>
            </ScrollReveal>
            <div className="space-y-4">
              {whyItems.map((item, i) => (
                <ScrollReveal key={item} variant="fadeLeft" delay={i * 0.08}>
                  <motion.div
                    className="flex items-center gap-3 p-4 rounded-lg bg-card border border-border ripple-effect gradient-border"
