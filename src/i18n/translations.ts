...
export const translations = {
  ...
  "offers.subtitle": { en: "Seasonal Promotions", ar: "عروض موسمية" },
  "offers.title1": { en: "Hot seasonal", ar: "عروض" },
  "offers.title2": { en: "discount codes", ar: "الخصومات" },
  "offers.description": { en: "Save more on our premium services with limited-time codes for every season.", ar: "وفر أكثر على خدماتنا المميزة مع رموز محدودة المدة لكل موسم." },
  "offers.springTitle": { en: "Spring Shine", ar: "تألق الربيع" },
  "offers.springDesc": { en: "Freshen up your car with exterior wash and interior polish at a special spring rate.", ar: "جدّد سيارتك بغسل خارجي وتلميع داخلي بسعر ربيعي خاص." },
  "offers.springBadge": { en: "Spring Special", ar: "عرض الربيع" },
  "offers.festiveTitle": { en: "Festive Care", ar: "العناية الاحتفالية" },
  "offers.festiveDesc": { en: "Get your vehicle holiday ready with premium detailing and protective finishing.", ar: "جهّز سيارتك للموسم الاحتفالي مع تنظيف فاخر وتشطيب وقائي." },
  "offers.festiveBadge": { en: "Festive Offer", ar: "عرض العيد" },
  "offers.yearEndTitle": { en: "Year-End Renewal", ar: "تجديد نهاية العام" },
  "offers.yearEndDesc": { en: "Finish the year strong with a deep service package and exclusive year-end savings.", ar: "اختم العام بقوة مع حزمة خدمة عميقة وتوفير حصري لنهاية العام." },
  "offers.yearEndBadge": { en: "Year-End Sale", ar: "تخفيض نهاية العام" },
  "offers.discountLabel": { en: "Discount", ar: "الخصم" },
  "offers.off": { en: "off", ar: "خصم" },
  "offers.codeLabel": { en: "Use code", ar: "استخدم الرمز" },
  "offers.bookNow": { en: "Book Now", ar: "احجز الآن" },
